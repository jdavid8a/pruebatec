                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li><a href="#userDataTab">Lista de Puntos de votación</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="" class="needsclick add-professors" method="post" id="FrmVotingStation">
                                                        <input name="txtVotingStationId" id="txtVotingStationId" type="hidden">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">                                                                   
                                                                    <input name="txtAddress" id="txtAddress" type="text" maxlength="50" class="form-control" placeholder="Dirección"  required="required"> 
                                                                </div>  
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                   ...
                                                                   <div class="form-group" id="dvCity"> 
                                                                    <?php
                                                                ...
                                                                <div class="form-group">
                                                                   ...
                                                                   <div  id="dvCboNeighborhood"> 
                                                                    <?php
                                                                            $sql="SELECT idBarrio,nombre FROM barrio ";
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light" onClick="saveVotingStation()">Guardar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                <div class="product-tab-list tab-pane fade" id="userDataTab">
                                   <?php
                                    include("../libs/tables/VotingStationList.php");
