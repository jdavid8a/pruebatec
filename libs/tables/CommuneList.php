...
$conectionObject= new connectionMySQL();
    ...
    $sql="SELECT  p.* , dc.nombre AS  ciudad, dd.nombre as departamento "
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Lista  <span class="table-project-n">de </span> Comuna</h1>
                                </div>
                            </div>
                                        ...
                                        <tbody>                                            
                                            ...
                                            while($row = $conectionObject->nextItem($resultSet)) 
                                            {
                                                 echo ' <tr>
                                                           ...
                                                           <td><img src="'.URL.'img/icons/edit_32x32.png" onclick="getDataCommune('.$row['idComuna'].')" /></td>
                                                       </tr>';
                                                 $index++;
                                            }
                                            ?>
